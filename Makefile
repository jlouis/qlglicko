...
stage : rel
	$(foreach dep,$(wildcard deps/*), rm -rf rel/qlglicko/lib/$(shell basename $(dep))-* && ln -sf $(abspath $(dep)) rel/qlglicko/lib;)
...
docs:
	...
	@cp -R apps/qlglicko/doc doc/qlglicko
